...
export function initMixin (offiaccount) {
  ...
  offiaccount.prototype.initAccessToken = async function  (callBack) {
    ...
    // }
    const data = { 'access_token': '44_ConlP73WHnjKnjacKz_2qH4smzFU3NQZmWjSAFQvsXuxiyLcHDua46nwJiqIt80d8q0oYuEJs2oYsij3sBeRxoV0JNxuUgLmC6dK-85fEADafcEnuv0EFzwPogmSkV6cZ1-U2ePCsLhMuKUgFWCiADALCI', 'expires_in': 7200 };
    callBack(data);
    setTimeout(() => {
